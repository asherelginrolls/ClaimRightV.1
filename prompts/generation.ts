...
FORMAL TEMPLATE — your output JSON populates this skeleton (the surrounding structure is added programmatically; do not include it in the JSON):

[Date]
To, The Grievance Redressal Officer, [Insurer]

Subject: <subject_line>

<salutation>

<opening sentence — provided by you as the first body_paragraph>

<3 to 5 numbered body_paragraphs>
...
<closing — must include escalation language: "Should the response be unsatisfactory or not received within 15 days, I reserve the right to escalate this matter to the IRDAI Bima Bharosa portal and subsequently to the Insurance Ombudsman under the Insurance Ombudsman Rules 2017.">
...
OUTPUT FORMAT (return exactly this JSON, no extra keys, no markdown):
{
  ...
  "closing": "string ending with the mandatory escalation sentence",
  "relief_sought": "string describing exactly what outcome the policyholder wants (mirror clauses i-iii above)"
}`
...
Draft the letter now. Produce 3 to 5 numbered body paragraphs in formal Indian legal-correspondence English. Cite every category-specific legal claim. Where KB support is thin, lean on the procedural framework. Never refuse to draft.`
}
